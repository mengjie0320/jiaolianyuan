...
<html lang="en">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/admin.php/Home/Work/listW">首页</a>
							</li>

							<li>
								<a href="/admin.php/Home/Work/listW">批阅中心</a>
							</li>
							<li>
								<a href="/admin.php/Home/Work/listW">已批阅项目列表</a>
							</li>
							<li class="active">项目批阅详情</li>
	...
	　　　　　　</div><!-- /.page-header -->
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
						<textarea readonly="" rows="10" cols="43" name="remark" value="<?php echo ($vo["remark"]); ?>" ><?php echo ($vo["remark"]); ?></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
						<input readonly="" type="date" name="remarkTime" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["remarktime"]); ?>" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						if($("[name=rank]").val() == ""){$("[name=status]").val("等待批阅")};
						if($("[name=rank]").val() == "0"){$("[name=status]").val("批阅通过，成绩为A")};
						if($("[name=rank]").val() == "1"){$("[name=status]").val("批阅通过，成绩为B")};
						if($("[name=rank]").val() == "2"){$("[name=status]").val("批阅通过，成绩为C")};
						if($("[name=rank]").val() == "3"){$("[name=status]").val("批阅通过，成绩为D")};
						if($("[name=rank]").val() == "4"){$("[name=status]").val("批阅不通过，成绩为E")};
						
						})
						</script>
						  　<input readonly="" type="text" name="status" value=""/>			　　
						  　<input readonly="" type="hidden" name="rank" value="<?php echo ($vo["rank"]); ?>"/>			　　
