...
<html lang="en">
	...
	　　　　　　</div><!-- /.page-header -->
					...
					<?php if(is_array($teacher)): foreach($teacher as $key=>$vo): endforeach; endif; ?>
					...
					<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">教练号：</label>

							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="tNo" id="form-input-readonly" value="<?php echo ($vo["tno"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
					...
					<div class="col-sm-9">
					<input type="text" name="tName" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["tname"]); ?>" />
					</div>
						</div>
						...
						<div class="col-sm-9">
						<input type="text" name="sex" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["sex"]); ?>" />
						</div>
					   </div>
						...
						<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">教练地址：</label>

						<div class="col-sm-9">
						<input type="text" name="address" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["address"]); ?>" />
						</div>
					   </div>
					   ...
					   <div class="form-group">
						...
						<div class="col-sm-9">
						<input type="text" name="phone" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["phone"]); ?>" />
						</div>
					   </div>
					   <div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">在线时间：</label>

						<div class="col-sm-9">
						<input type="date" name="onlineTime" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["onlinetime"]); ?>" />
						</div>
					   </div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="myEditor">个人简介：</label>
						
							<div class="col-sm-9">
								<textarea rows="10" cols="53" name="tIntro" value="<?php echo ($vo["tintro"]); ?>" ><?php echo ($vo["tintro"]); ?>;</textarea>
						    </div>
					   </div> 
