...
<html lang="en">
	...
	　　　　　　</div><!-- /.page-header -->
					...
					<?php if(is_array($student)): foreach($student as $key=>$vo): endforeach; endif; ?>
					...
					<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">学号：</label>

							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="stuNo" id="form-input-readonly" value="<?php echo ($vo["stuno"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
					...
					<div class="col-sm-9">
					<input type="text" name="stuName" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["stuname"]); ?>" />
					</div>
						</div>
						...
						<div class="col-sm-9">
						<input type="text" name="school" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["school"]); ?>" />
						</div>
					   </div>
					   ...
					   <div class="form-group">
						...
						<div class="col-sm-9">
						<input type="date" name="regTime" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["regtime"]); ?>" />
						</div>
					   </div>
