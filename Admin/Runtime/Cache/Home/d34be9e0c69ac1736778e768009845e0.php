...
<html lang="en">
				...
				<div class="main-content" >
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="/admin.php/Home/Cate/listC">分类管理</a>
							</li>
	...
	　　　　　　</div><!-- /.page-header -->
					...
					<?php if(is_array($cate)): foreach($cate as $key=>$vo): endforeach; endif; ?>
					...
					<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">编号：</label>

							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="cNo" id="form-input-readonly" value="<?php echo ($vo["cno"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
					...
					<div class="col-sm-9">
					<input type="text" name="cName" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["cname"]); ?>" />
					</div>
						</div>
