			...
			<div class="main-container-inner">
				...
				<div class="main-content" >
					...
					<ul class="breadcrumb" style="line-height:50px;">
							...
							<li><a href="/admin.php/Home/Teacher/AuditStatusFinish">已完成认证教练列表</a></li>
							<li class="active">教练认证详情</li>
				...
				<div  style="margin-left:5px;font-size:20px;">
					...
					<ul style=" list-style-type:none;">
						...
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-time">				</i> 申请认证时间:</span>　 <?php echo ($vo["applytime"]); ?></li>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-barcode">			</i> 申请任教班级:</span>　 <?php echo ($vo["classname"]); ?></li>
						<li style="padding:10px 10px 50px 10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-list-alt"></i> 申请任教理由:</span>　 <?php echo ($vo["reason"]); ?></li>
						<?php if($vo['auditstatus'] == '1'): ?><li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-edit">				</i> 申请认证结果:</span>　 认证通过</li>
						<?php else: ?>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-edit">				</i> 申请认证结果:</span>　 认证不通过</li><?php endif; endforeach; endif; ?>
					</ul>
				</div>
