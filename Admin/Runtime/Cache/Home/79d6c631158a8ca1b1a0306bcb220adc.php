...
<html lang="en">
	...
	　　　　　　</div><!-- /.page-header -->
					...
					<?php if(is_array($class)): foreach($class as $key=>$vo): endforeach; endif; ?>
					...
					<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">班 　 　 号：</label>

							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="classNo" id="form-input-readonly" value="<?php echo ($vo["classno"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-2">班 级 名 称：</label>

							<div class="col-sm-9">
							<input type="text" name="className" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["classname"]); ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-2">班 级 价 格：</label>

							<div class="col-sm-9">
							<input type="text" name="classPrice" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["coachmaxprice"]); ?>　元" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							<input type="text" name="classPrice" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["coachminprice"]); ?>　元" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							<input type="text" name="classPrice" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["classprice"]); ?>　元" />
							</div>
						</div>
						...
						<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">开 班 时 间：</label>

						<div class="col-sm-9">
						<input type="date" name="startTime" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["starttime"]); ?>" />
						</div>
					   </div>
					   
					   <div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">平 均 周 期：</label>

						<div class="col-sm-9">
						<input type="text" name="avePeriod" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["aveperiod"]); ?>" />
						</div>
					   </div>
					   
					   <div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">班 级 简 介：</label>

						<div class="col-sm-9">
						<textarea rows="10" cols="53" name="classIntro" value="<?php echo ($vo["classintro"]); ?>" ><?php echo ($vo["classintro"]); ?></textarea>
						</div>
					   </div>
					   ...
					   <div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">修 改 项 目：</label>
						
						<?php if(is_array($project_list)): foreach($project_list as $key=>$vo): ?>　　<input type="checkbox" id="checkbox" name="project[]" value="<?php echo ($vo["name"]); ?>"/>
						　<?php echo ($vo["name"]); endforeach; endif; ?>
						<?php if(is_array($class_project_list)): foreach($class_project_list as $key=>$vo): ?>　　<input type="hidden" name="name[]" value="<?php echo ($vo["name"]); ?>"/><?php endforeach; endif; ?>
						<script>
						 window.onload = function (){
								var checkbox  = document.getElementsByName("project[]");
								 var checkbox2 = document.getElementsByName("name[]");
								 //alert(checkbox2.length);
									for (var i=0;i<checkbox.length;i++){
									  for (var j=0;j<checkbox2.length;j++){
									  if(checkbox[i].value == checkbox2[j].value){
					  ...
					  <!--  <div class="form-group">
						...
						<?php if(is_array($cate_list)): foreach($cate_list as $key=>$vo): ?>　　<input type="radio" name="name" />
