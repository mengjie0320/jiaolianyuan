												 ...
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<td>
															...
															<div id="anNiu">
																...
																<a href="/admin.php/Home/Teacher/detail?id=<?php echo ($vo["id"]); ?>" title="查看详情"><i class="icon-user-md bigger-180"></i></a>
																</button>

																<button class="btn btn-xs  btn-info">
																<a href="/admin.php/Home/Teacher/prepare?mode=update&id=<?php echo ($vo["id"]); ?>" title="编辑"><i class="icon-edit fa fa-check bigger-180"></i></a>
																</button>

																<button class="btn btn-xs btn-danger">
																<a href="/admin.php/Home/Teacher/delete?deleteID=<?php echo ($vo["id"]); ?>" title="删除"><i class="icon-trash bigger-180"></i></a>
																</button>
															</div>
														</td>														
												   ...
												   <thead>
													<tr>
														...
														<th></th>
														<th></th>
														<th class="center"><a href="/admin.php/Home/Teacher/prepare?mode=''">添加教练</a></th>
													</tr>
												</thead>
												</tbody>
											</table>
