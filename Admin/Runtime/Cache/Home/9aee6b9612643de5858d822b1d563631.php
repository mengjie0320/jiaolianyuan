												 ...
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<td>
															...
															<div id="anNiu">
																...
																<a href="/admin.php/Home/Cate/prepare?mode=update&id=<?php echo ($vo["id"]); ?>" title="编辑"><i class="icon-edit fa fa-check bigger-180"></i></a>
																</button>

																<button class="btn btn-xs btn-danger">
																<a href="/admin.php/Home/Cate/delete?deleteID=<?php echo ($vo["id"]); ?>" title="删除"><i class="icon-trash bigger-180"></i></a>
																</button>
															</div>
														</td>														
												   ...
												   <thead>
													<tr>
														...
														<th class="center"><a href="/admin.php/Home/Cate/prepare?mode=''">添加分类</a></th>
													</tr>
												</thead>
												</tbody>
											</table>
