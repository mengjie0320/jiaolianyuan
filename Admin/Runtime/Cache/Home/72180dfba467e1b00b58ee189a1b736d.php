		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
			 ...
			 <ul class="breadcrumb">
							...
							<li class="active"><a href="/admin.php/Home/Student/index">学员管理</a></li>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center">在学班级</th>
														<th class="center">在学项目</th>
												 ...
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<td>
															...
															<div id="anNiu">
																...
																<a href="/admin.php/Home/Student/detail?id=<?php echo ($vo["id"]); ?>" title="查看详情"><i class="icon-user-md bigger-180"></i></a>
																</button>

																<button class="btn btn-xs  btn-info">
																<a href="/admin.php/Home/Student/prepare?mode=update&id=<?php echo ($vo["id"]); ?>" title="编辑"><i class="icon-edit fa fa-check bigger-180"></i></a>
																</button>

																<button class="btn btn-xs btn-danger">
																<a href="/admin.php/Home/Student/delete?deleteID=<?php echo ($vo["id"]); ?>" title="删除"><i class="icon-trash bigger-180"></i></a>
																</button>
															</div>
														</td>														
												   ...
												   <thead>
													<tr>
														...
														<th></th>
														<th></th>
														<th class="center"><a href="/admin.php/Home/Student/prepare?mode=''">添加学生</a></th>
													</tr>
												</thead>
												</tbody>
											</table>
