											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center">班号</th>
														<th class="center">班级名称</th>
														<th class="center">班级价格</th>
												...
												<tbody>
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<td><?php echo ($vo["classprice"]); ?></td>
                                                        <td><?php echo ($vo["starttime"]); ?></td>
														<td><?php echo ($vo["aveperiod"]); ?></td>
														<td title="<?php echo ($vo["classintro"]); ?>"><div style="width:185px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo ($vo["classintro"]); ?></div></td>	
														...
														<td>
															...
															<div id="anNiu">
																...
																<a href="/admin.php/Home/Class/detail?id=<?php echo ($vo["id"]); ?>" title="查看详情"><i class="icon-search bigger-180"></i></a>
																</button>

																<button class="btn btn-xs  btn-info">
																<a href="/admin.php/Home/Class/prepare?mode=update&id=<?php echo ($vo["id"]); ?>" title="编辑"><i class="icon-edit fa fa-check bigger-180"></i></a>
																</button>

																<button class="btn btn-xs btn-danger">
																<a href="/admin.php/Home/Class/delete?deleteID=<?php echo ($vo["id"]); ?>" title="删除"><i class="icon-trash bigger-180"></i></a>
																</button>
															</div>
														</td>														
												   ...
												   <thead>
													<tr>
														...
														<th class="center"><a href="/admin.php/Home/Class/prepare?mode=''">添加班级</a></th>
													</tr>
												</thead>
												</tbody>
											</table>
