											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center">完成项目所用时间</th>
														<th class="center">下载项目源码</th>
												...
												<tbody>
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<td><div style="width:160px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo ($vo["name"]); ?></div></td>
														<td><?php echo ($vo["submittime"]); ?></td>
														<td><?php echo ($vo["finishedtime"]); ?></td>
														<td><div style="width:185px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><a href="<?php echo ($vo["workurl"]); ?>"><?php echo ($vo["workurl"]); ?></a></div></td>
														<?php if($vo['status'] == '0'): ?><td style="color:red">等待审核</td>
														<?php else: endif; ?>
														<td>
															...
															<div id="anNiu" >
																...
																<a href="/admin.php/Home/Work/prepareForEvaluate?id=<?php echo ($vo["id"]); ?>" title="评阅"><i class="icon-edit fa fa-check bigger-180"></i></a>
																</button>
