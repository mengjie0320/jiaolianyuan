											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center">时间指标</th>													
														<th class="center">项目资料</th>
												...
												<tbody>
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<td><?php echo ($vo["requiretime"]); ?>天</td>
														<td><a href="<?php echo ($vo["dataurl"]); ?>"><?php echo ($vo["dataurl"]); ?></a></td>
														...
														<td>
															...
															<div id="anNiu">
																...
																<a href="/admin.php/Home/Project/detail?id=<?php echo ($vo["id"]); ?>" title="查看详情"><i class="icon-search bigger-180"></i></a>
																</button>

																<button class="btn btn-xs  btn-info">
																<a href="/admin.php/Home/Project/prepare?mode=update&id=<?php echo ($vo["id"]); ?>" title="编辑"><i class="icon-edit fa fa-check bigger-180"></i></a>
																</button>

																<button class="btn btn-xs btn-danger">
																<a href="/admin.php/Home/Project/delete?deleteID=<?php echo ($vo["id"]); ?>" title="删除"><i class="icon-trash bigger-180"></i></a>
																</button>
															</div>
														</td>														
												   ...
												   <thead>
													<tr>
														...
														<th></th>
														<th></th>				
														<th class="center"><a href="/admin.php/Home/Project/prepare?mode=''">添加项目</a></th>
													</tr>
												</thead>
												</tbody>
											</table>
