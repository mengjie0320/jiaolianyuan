											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center">收件人分类</th>	
														<th class="center">收件人名称</th>	
												...
												<tbody>
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<?php elseif($vo['sendertype'] == '0' ): ?>
														<td>教练缘管理员</td>
														<?php else: ?>
														<td>教练</td><?php endif; ?>
														<td><?php echo ($vo["targetname"]); ?></td>
												   ...
												   <thead>
													<tr>
														...
														<th></th>
														<th></th>
														<th class="center"><a href="/jiaolianyuan/admin.php/Home/Message/send">发送消息</a></th>
													</tr>
												</thead>
												</tbody>
											</table>
