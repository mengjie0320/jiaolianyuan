			...
			<div class="main-container-inner">
				...
				<div  style="margin-left:5px;font-size:20px;">
					...
					<ul style=" list-style-type:none;">
						<?php if(is_array($list_1)): foreach($list_1 as $key=>$vo): ?><li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-user">			</i> 姓　　名:</span>　 <?php echo ($vo["stuname"]); ?></li>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-barcode">			</i> 学　　号:</span>　 <?php echo ($vo["stuno"]); ?></li>
						...
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon  glyphicon-flag">	</i> 所在学校:</span>　 <?php echo ($vo["school"]); ?></li>
						<li style="padding:10px 10px 50px 10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-check">		</i> 注册时间:</span>　 <?php echo ($vo["regtime"]); ?></li><?php endforeach; endif; ?>
						</ul>

						<ul style=" list-style-type:none;">
						<?php if(is_array($list_3)): foreach($list_3 as $key=>$vo): if($vo['status'] == '0'): ?><li style="padding:10px;border-bottom:1px solid #F2F2F2;">
						<span style="float:left;font-weight:700;"><i class="glyphicon glyphicon-home"></i> 在学班级:</span>
						<span style="float:left;margin-left:20px;display:block;width:250px;"><?php echo ($vo["classname"]); ?></span>
						<span style="font-weight:700;"><i class="glyphicon glyphicon-book"></i> 在学项目:</span>　 <?php echo ($vo["projectname"]); ?>
						</li>
						
						<li style="padding:10px 10px 50px 10px;border-bottom:1px solid #F2F2F2;">
						<span style="float:left;font-weight:700;"><i class="glyphicon glyphicon-time"></i> 剩余时间:</span>
						<span style="float:left;margin-left:20px;display:block;width:250px;"><?php echo ($vo["declinetime"]); ?></span><span style="font-weight:700;"><i class="glyphicon glyphicon-user"></i> 教练姓名:</span>　 <?php echo ($vo["tname"]); ?>
						</li>
						...
						<span style="float:left;font-weight:700;"><i class="glyphicon glyphicon-unchecked"></i> 已学班级:</span>
						<span style="float:left;margin-left:20px;display:block;width:250px;"><?php echo ($vo["classname"]); ?></span>
						<span style="font-weight:700;"><i class="glyphicon glyphicon-unchecked"></i>已学项目:</span>　 <?php echo ($vo["projectname"]); ?></li><?php endforeach; endif; ?>
						</ul>
				</div>
				<!-- /Contact Info -->
				<div class="clear"></div>
