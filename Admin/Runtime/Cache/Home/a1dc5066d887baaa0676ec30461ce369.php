			...
			<div class="main-container-inner">
				...
				<div class="main-content" >
					...
					<ul class="breadcrumb" style="line-height:50px;">
							...
							<li><a href="/admin.php/Home/Teacher/checkAuditStatus">等待认证教练列表</a></li>
				...
				<div  style="margin-left:5px;font-size:20px;">
					...
					<ul style=" list-style-type:none;">
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-user">			</i> 姓　　名:</span>　 <?php echo ($vo["tname"]); ?></li>
						...
						<li style="padding:10px 10px 50px 10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-list-alt">		</i> 个人简介:</span>　 <?php echo ($vo["tintro"]); ?></li>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-list-alt">		</i> 申请认证时间:</span>　 <?php echo ($vo["applytime"]); ?></li>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-list-alt">		</i> 申请任教班级:</span>　 <?php echo ($vo["classname"]); ?></li>
						<li style="padding:10px 10px 50px 10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-list-alt">		</i> 申请任教理由:</span>　 <?php echo ($vo["reason"]); ?></li><?php endforeach; endif; ?>
					</ul>
				</div>
				<div>
				<form action="updateAuditStatus" method="post" class="form-horizontal" role="form">
					
					<div class="form-group">
							<div class="col-sm-9">
								<input readonly="" type="hidden" class="col-xs-10 col-sm-5" name="id" id="form-input-readonly" value="<?php echo ($vo["id"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="hidden" id="id-disable-check" />
									</label>
								</span>
							</div>
					</div>
					...
					<div id="status" class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">审核认证：</label>					
						　
						  　<input type="radio" name="auditStatus" value="1"/>&nbsp认证通过		　　
						  　<input type="radio" name="auditStatus" value="2"/>&nbsp认证不通过		　　
						  　
							　　
