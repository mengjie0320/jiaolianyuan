...
window.onload=function(){
		...
		//if($('#stuName').length>0){alert('123')}else{alert('456')};
            ...
            function() {
                ...
                if(request == ""){$('#mess3').html("项目要求不能为空！");}
				else{ 
					$('#mess3').html("");  
				} 
            });
			...
			$('#requireTime').blur(
            function() {
                var requireTime = $(this).val();
                if(requireTime == ""){$('#mess4').html("时间要求不能为空！");}
				else{ 
					$('#mess4').html("");  
				} 
            });
            ...
            function() {
                ...
                if(dataUrl == ""){$('#mess5').html("项目资料不能为空！");}
				else{ 
					$('#mess5').html("");  
				} 
            });
			...
			$('#submit1').click(function() {  
				...
				if ($('#sense').val() == '') {  
					...
					<div class="space-4"></div>
						...
						<div class="col-sm-9">
							<input type="text" name="request" id="request"  class="col-xs-10 col-sm-5" />
							<div id="tooltip3" >  
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="requireTime" id="requireTime"  class="col-xs-10 col-sm-5" />天
							<div id="tooltip4" >  
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="dataUrl" id="dataUrl"  class="col-xs-10 col-sm-5" />
							<div id="tooltip5" >  
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea rows="10" cols="53" name="sense" id="sense" value="<?php echo ($vo["sense"]); ?>" ></textarea>
							<div id="tooltip6" >  
