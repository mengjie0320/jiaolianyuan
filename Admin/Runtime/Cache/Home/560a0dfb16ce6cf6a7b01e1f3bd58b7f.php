...
<html lang="en">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/admin.php/Home/Work/index">首页</a>
							</li>

							<li>
								<a href="/admin.php/Home/Work/index">批阅中心</a>
							</li>
							<li>
								<a href="/admin.php/Home/Work/index">未批阅项目列表</a>
							</li>
	...
	　　　　　　</div><!-- /.page-header -->
					...
					<?php if(is_array($content)): foreach($content as $key=>$vo): endforeach; endif; ?>
					<?php if(is_array($content2)): foreach($content2 as $key=>$vo): endforeach; endif; ?>
					
					<form action="evaluate" method="post" class="form-horizontal" role="form">
					...
					<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">学生姓名：</label>

							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="stuName" id="form-input-readonly" value="<?php echo ($vo["stuname"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
					...
					<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">就读班级：</label>

							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="className" id="form-input-readonly" value="<?php echo ($vo["classname"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
					...
					<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="name" id="form-input-readonly" value="<?php echo ($vo["name"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
					...
					<div class="form-group">
							...
							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="submitTime" id="form-input-readonly" value="<?php echo ($vo["submittime"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
					...
					<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">完成用时：</label>

							<div class="col-sm-9">
								<input readonly="" type="text" class="col-xs-10 col-sm-5" name="finishedTime" id="form-input-readonly" value="<?php echo ($vo["finishedtime"]); ?>" />
								<span class="help-inline col-xs-12 col-sm-7">
									<label class="middle">
										<input class="ace" type="checkbox" id="id-disable-check" />
									</label>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">评阅内容：</label>

						<div class="col-sm-9">
						<textarea rows="10" cols="51" name="remark" value="<?php echo ($vo["remark"]); ?>" ><?php echo ($vo["remark"]); ?></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">评阅时间：</label>

						<div class="col-sm-9">
						<input type="date" name="remarkTime" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($vo["remarktime"]); ?>" />
						</div>
					</div>
					...
					<div id="status" class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-2">批阅成绩：</label>					
						　
						  　<input type="radio" name="rank" value="0"/>&nbspA		　　
						  　<input type="radio" name="rank" value="1"/>&nbspB		　　
						  　<input type="radio" name="rank" value="2"/>&nbspC		　　
						  　<input type="radio" name="rank" value="3"/>&nbspD	　　
						  　<input type="radio" name="rank" value="4"/>&nbspE
							　　
					   <script>
					   $(":radio").click(
							function() {
						if($(this).val() != "4"){$("[name=status]").val("1")};	
						if($(this).val() == "4"){$("[name=status]").val("2")};
						})
						</script>
						<input type="hidden" name="status" value="">　　　
						  <!-- <script>
						  window.onload = function (){
							var oSt = document.getElementsByName('status');
							var oSt2 = document.getElementsByName('status2');
							var oDiv = document.getElementById('status');
								for (var i=0;i<oSt.length;i++){
								  for (var j=0;j<oSt2.length;j++){
									if(oSt[i].value == oSt2[i].value){
						...
						<input type="hidden" name="stuId" value="<?php echo ($vo["stuid"]); ?>" />
