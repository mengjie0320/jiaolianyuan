			...
			<div class="main-container-inner">
				...
				<div  style="margin-left:30px;font-size:20px;">
					...
					<ul style=" list-style-type:none;">
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-tag">						</i> 项目名称:</span>　 <?php echo ($vo["name"]); ?></li>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-list">						</i> 所属分类:</span>　 <?php echo ($vo["cname"]); ?></li>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-time">					</i> 时间指标:</span>　 <?php echo ($vo["requiretime"]); ?></li>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-hand-right">						</i> 项目要求:</span>　 <?php echo ($vo["request"]); ?></li>
						<li style="padding:10px;border-bottom:1px solid #F2F2F2;"><span style="font-weight:700;"><i class="glyphicon glyphicon-list-alt">					</i> 项目意义:</span>　 <?php echo ($vo["sense"]); ?></li><?php endforeach; endif; ?>
						</ul>
