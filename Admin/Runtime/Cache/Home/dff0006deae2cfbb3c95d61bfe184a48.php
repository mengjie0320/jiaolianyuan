											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<?php if($vo['auditstatus'] == '1'): ?><td>认证通过</td>
														<?php elseif($vo['auditstatus'] == '2'): ?>
														<td>认证不通过</td><?php endif; ?>
														<td>
														
															<div id="anNiu">
																<button class="btn btn-xs btn-success">
																<a href="/admin.php/Home/Teacher/AuditStatusDetail?id=<?php echo ($vo["id"]); ?>" title="查看详情"><i class="icon-search bigger-180"></i></a>
																</button>
															</div>
														</td>														
