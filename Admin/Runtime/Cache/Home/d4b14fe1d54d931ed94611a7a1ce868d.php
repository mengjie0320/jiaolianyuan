											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												 <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="center">
														...
														<?php if($vo['auditstatus'] == '0'): ?><td style="color:red;">等待认证</td><?php endif; ?>
														<td>
														
															<div id="anNiu">

																<button class="btn btn-xs  btn-info">
																<a href="/admin.php/Home/Teacher/checkAuditStatusDetail?id=<?php echo ($vo["id"]); ?>" title="认证"><i class="icon-edit fa fa-check bigger-180"></i></a>
																</button>
